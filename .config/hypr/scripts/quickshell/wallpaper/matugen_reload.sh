...
# ------------------------------------------------------------------------------
# AVE_DYNAMIC_THEME_SYNC
# ------------------------------------------------------------------------------

# Regenerate Fastfetch colors from the same Quickshell palette.
python3 "$HOME/.config/hypr/scripts/update-fastfetch-theme.py" \
    >/dev/null 2>&1 || true

# Force Hyprland to reread generated colors.conf.
hyprctl reload >/dev/null 2>&1 || true


# ------------------------------------------------------------------------------
# AVE_EDEX_DYNAMIC_THEME
# ------------------------------------------------------------------------------

python3 "$HOME/.config/hypr/scripts/update-edex-theme.py" \
    >/dev/null 2>&1 || true
