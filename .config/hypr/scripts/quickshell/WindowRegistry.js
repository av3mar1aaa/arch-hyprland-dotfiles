...
function getLayout(name, mx, my, mw, mh, userScale) {
    ...
    let base = {
        ...
        "controlcenter": {
            ...
            comp: "controlcenter/ControlCenter.qml"
        },
        ...
        "keybinds": {
            w: s(1120, scale),
            h: s(760, scale),
            rx: Math.floor((mw / 2) - (s(1120, scale) / 2)),
            ry: Math.floor((mh / 2) - (s(760, scale) / 2)),
            comp: "keybinds/KeybindsPopup.qml"
        },
