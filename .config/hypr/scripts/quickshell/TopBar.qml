                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                color: isHovered ? Qt.rgba(mocha.surface1.r, mocha.surface1.g, mocha.surface1.b, 0.18) : "transparent"
                                ...
                                Row { 
                                    ...
                                    anchors.leftMargin: barWindow.s(12)
                                    spacing: barWindow.s(8)
                                    Text { anchors.verticalCenter: parent.verticalCenter; text: "󰌌"; font.family: "Iosevka Nerd Font"; font.pixelSize: barWindow.s(16); color: parent.parent.isHovered ? mocha.text : mocha.teal }
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        color: barWindow.showEthernet ? (barWindow.ethStatus === "Connected" ? mocha.blue : mocha.subtext0) : (barWindow.isWifiOn ? mocha.blue : mocha.subtext0)
                                    }
                                    Text { 
                                        id: wifiText
                                        anchors.verticalCenter: parent.verticalCenter
                                        ...
                                        color: barWindow.showEthernet ? (barWindow.ethStatus === "Connected" ? mocha.blue : mocha.text) : (barWindow.isWifiOn ? mocha.blue : mocha.text);
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        color: barWindow.isSoundActive ? mocha.peach : mocha.subtext0 
                                    }
                                    Text { 
                                        anchors.verticalCenter: parent.verticalCenter
                                        text: barWindow.volPercent; 
                                        font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(13); font.weight: Font.Black; 
                                        color: barWindow.isSoundActive ? mocha.peach : mocha.text; 
                                    }
                                }
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        color: barWindow.isDesktop ? mocha.peach : barWindow.batDynamicColor 
